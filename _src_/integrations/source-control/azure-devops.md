...
![VCS providers page](<../../.gitbook/assets/image (88).png>)

This should open a form like this one:

![Azure DevOps setup form](<../../.gitbook/assets/image (89).png>)
...
![Azure DevOps main organization page](../../.gitbook/assets/azureDevOps1.png)
...
![Personal access tokens menu in Azure DevOps](../../.gitbook/assets/azureDevOpsPersonalAccessToken1.png)

2\. On the **Personal Access Tokens** page click **+ New Token**

![Personal Access Tokens page in Azure DevOps](../../.gitbook/assets/azureDevOpsPersonalAccessToken3.png)
...
![Creating a new personal access token in Azure DevOps](../../.gitbook/assets/azureDevOps-personalAccessToken3.png)

4\. Once the token is created, put it into the **Personal access token** field on the Spacelift Azure DevOps setup form.

![Successfully created Personal Access Token in Azure DevOps](../../.gitbook/assets/azureDevOpsPeronalAccessToken5.png)

### Creating the Integration

After doing all this you should have all fields filled in.

![Filled in Azure DevOps integration form](../../.gitbook/assets/azureDevOpsPeronalAccessToken6.png)
...
![Configured Azure DevOps integration](<../../.gitbook/assets/image (92).png>)
...
![Creating a Webhook integration in Azure DevOps](../../.gitbook/assets/azureWebhooks1.gif)
...
![Creating Code pushed webhook integration in Azure DevOps](../../.gitbook/assets/azureWebhooks2.png)
...
![Configuring webhook integration in Azure DevOps](../../.gitbook/assets/azureWebhooks3.png)
...
![Service Hooks page with four configured webhook integrations in Azure DevOps](<../../.gitbook/assets/image (108) (1).png>)

## Using the Integration

When creating a Stack, you will now be able to choose the Azure DevOps provider and a repository inside of it:

![Stack creation form](<../../.gitbook/assets/image (93).png>)
...
![VCS providers page](<../../.gitbook/assets/image (94).png>)
