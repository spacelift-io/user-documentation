...
![Select Applications](../../.gitbook/assets/2-select-okta-applications.png)
...
![Click Create App Integration](../../.gitbook/assets/3-create-app-integration.png)

![Select OIDC and Web Application, Click Next](../../.gitbook/assets/4-create-app-integration-modal.png)
...
![Configure Okta App Integration](../../.gitbook/assets/5-configure-app-integration.png)
...
![](../../.gitbook/assets/8-okta-group-claims.png)
...
![Copy the 3 Values back to Spacelift](../../.gitbook/assets/6-configure-spacelift-oidc-settings.png)

![Copy/Paste the values into your Spacelift OIDC Settings, Click Save](../../.gitbook/assets/7-configure-spacelift-oidc-settings-part-2.png)
