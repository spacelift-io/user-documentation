...
!!! tip
    We maintain a [library of example policies](https://github.com/spacelift-io/spacelift-policies-example-library/tree/main/access) that are ready to use or that you could tweak to meet your specific needs.
