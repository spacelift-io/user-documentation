...
1. [Personal GitHub Token > Token](api.md#personal-github-token-greater-than-jwt-token)
2. [Spacelift API Key > Token](api.md#spacelift-api-key-greater-than-jwt-token)
3. [SpaceCTL CLI > Token](api.md#undefined)
...
Spacelift supports creating and managing machine users with programmatic access to Spacelift API. These are called API Keys and can be created by Spacelift admins through the _Settings_ panel.
...
![Click Settings.](/assets/images/1-cilck-settings.png)

Click _API Keys._

![Click API Keys.](/assets/images/2-click-api-keys.png)
...
![Create and Configure your new API Key.](/assets/images/3-create-api-key.png)
...
![Download your API Key.](/assets/images/4-download-api-key.png)
...
Another approach to generating this token is using the Spacelift [spacectl](https://github.com/spacelift-io/spacectl) CLI.

**Steps:**

1. Follow the instructions on the [GitHub repository](https://github.com/spacelift-io/spacectl) to install the spacectl CLI on your machine.
2. Authenticate using `spacectl profile login`
3. Once authenticated with your Spacelift account, run `spacelift profile export-token` to receive the bearer token needed for future GraphQL queries/mutations.
...
![Example viewing GraphQL documentation using Insomnia.](/assets/images/Spacelift_%E2%80%93_GraphQL.png)

### GraphiQL Example

_Input your GraphQL Endpoint for your Spacelift Account._

![Click Docs.](/assets/images/1-graphiql.png)

_Use the Documentation Explorer within GraphiQL_

![](/assets/images/2-graphiql-view-docs.png)
