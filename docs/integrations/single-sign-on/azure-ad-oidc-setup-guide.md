...
![](/assets/images/1-spacelift-account-settings.png)
...
![](/assets/images/2-spacelift-copy-exchange-url.png)
...
![Navigate to your Azure Active Directory.](/assets/images/1-azure-navigate-to-azure-ad.png)
...
![Click on App Registrations, then click New Registration.](/assets/images/2-azure-ad-new-registration.png)
...
![Give your App Registration a name. Configure the redirect URI.](/assets/images/3-azure-create-app-integration-step-1.png)

### Azure AD: Configure App Credentials

Navigate to the **Certificates & secrets** section of your application.

![Navigate to Credentials & secrets.](/assets/images/3-azure-navigate-to-credentials.png)

Click the **New client secret** button.

![Click New client secret.](/assets/images/4-azure-new-client-secret.png)
...
![Define client secret Description and Expires duration.](/assets/images/5-azure-new-secret.png)
...
![Copy the Value to your Spacelift OIDC settings as the "Secret".](/assets/images/Screen%20Shot%202022-04-14%20at%2011.03.31%20AM.png)
...
![Copy the OpenID Connect metadata document URL.](/assets/images/6-azure-obtain-provider-url.png)

The result should look something like this in Spacelift:

![](/assets/images/7-spacelift-oidc-setup-result%20%281%29.png)
