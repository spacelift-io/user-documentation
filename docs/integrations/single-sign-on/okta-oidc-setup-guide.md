...
![Select Applications](/assets/images/2-select-okta-applications.png)
...
![Click Create App Integration](/assets/images/3-create-app-integration.png)

![Select OIDC and Web Application, Click Next](/assets/images/4-create-app-integration-modal.png)
...
![Configure Okta App Integration](/assets/images/5-configure-app-integration.png)
...
![](/assets/images/8-okta-group-claims.png)
...
![Copy the 3 Values back to Spacelift](/assets/images/6-configure-spacelift-oidc-settings.png)

![Copy/Paste the values into your Spacelift OIDC Settings, Click Save](/assets/images/7-configure-spacelift-oidc-settings-part-2.png)
