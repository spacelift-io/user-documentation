...
![](../../assets/screenshots/Settings\_·\_Terraform\_starter.png)
...
![](../../assets/screenshots/Edit\_stack\_·\_Terraform\_starter.png)

Once selected, the AWS integration setup screen will look like this:

![](../../assets/screenshots/Edit\_stack\_·\_Stack\_for\_01F2PPCV76FAP64VXP6FBEEHJE.png)
...
![](<../../assets/screenshots/Edit\_stack\_·\_Stack\_for\_01F2PPCV76FAP64VXP6FBEEHJE (1).png>)
...
![☠️ Don't touch anything here unless you really know what you're doing ☠️](../../assets/screenshots/IAM\_Management\_Console.png)
...
![](<../../assets/screenshots/IAM\_Management\_Console (1).png>)
...
![](<../../assets/screenshots/IAM\_Management\_Console (2).png>)

…and here's where to paste it:

![](<../../assets/screenshots/Edit\_stack\_·\_Terraform\_starter (3).png>)
...
![](<../../assets/screenshots/Edit\_stack\_·\_Terraform\_starter (4).png>)

![Pasting the JSON statement](<../../assets/screenshots/IAM\_Management\_Console (3).png>)
...
![](../../assets/screenshots/CloudTrail\_Management\_Console.png)

`01DSJ63P40BAZY4VW8BXXG7M4K` is indeed a run ID we can then trace back even further:

![](../../assets/screenshots/01DSJ63P40BAZY4VW8BXXG7M4K\_·\_End-to-end\_testing.png)
