...
![](/assets/images/Settings_%C2%B7_Terraform_starter.png)
...
![](/assets/images/Edit_stack_%C2%B7_Terraform_starter.png)

Once selected, the AWS integration setup screen will look like this:

![](/assets/images/Edit_stack_%C2%B7_Stack_for_01F2PPCV76FAP64VXP6FBEEHJE.png)
...
![](/assets/images/Edit_stack_%C2%B7_Stack_for_01F2PPCV76FAP64VXP6FBEEHJE%20%281%29.png)
...
![☠️ Don't touch anything here unless you really know what you're doing ☠️](/assets/images/IAM_Management_Console.png)
...
![](/assets/images/IAM_Management_Console%20%281%29.png)
...
![](/assets/images/IAM_Management_Console%20%282%29.png)

…and here's where to paste it:

![](/assets/images/Edit_stack_%C2%B7_Terraform_starter%20%283%29.png)
...
![](/assets/images/Edit_stack_%C2%B7_Terraform_starter%20%284%29.png)

![Pasting the JSON statement](/assets/images/IAM_Management_Console%20%283%29.png)
...
![](/assets/images/CloudTrail_Management_Console.png)

`01DSJ63P40BAZY4VW8BXXG7M4K` is indeed a run ID we can then trace back even further:

![](/assets/images/01DSJ63P40BAZY4VW8BXXG7M4K_%C2%B7_End-to-end_testing.png)
