...
![](/assets/images/Installing_spacelift_io.png)
...
![](/assets/images/Test_a_change_by_marcinwyszynski_%C2%B7_Pull_Request__6_%C2%B7_spacelift-io_marcinw-end-to-end.png)

...when it succeeds _without changes_:

![](/assets/images/Test_a_change_by_marcinwyszynski_%C2%B7_Pull_Request__6_%C2%B7_spacelift-io_marcinw-end-to-end%20%282%29.png)

...when it succeeds _with changes_:

![](/assets/images/Test_a_change_by_marcinwyszynski_%C2%B7_Pull_Request__6_%C2%B7_spacelift-io_marcinw-end-to-end%20%281%29.png)

...and when it fails:

![](/assets/images/Test_a_change_by_marcinwyszynski_%C2%B7_Pull_Request__6_%C2%B7_spacelift-io_marcinw-end-to-end%20%283%29.png)

In each case, clicking on the _Details_ link will take you to the GitHub check view showing more details about the run:

![](/assets/images/Add_Azure_integration_variables_by_adamconnelly_%C2%B7_Pull_Request__561_%C2%B7_spacelift-io_infra%20%281%29.png)
...
![](/assets/images/Update_README_md_%C2%B7_Private_worker_pool.png)
...
![](/assets/images/New_branch_protection_rule%20%281%29.png)
...
![](/assets/images/Deployments_%C2%B7_spacelift-io_marcinw-end-to-end%20%281%29.png)
...
![](/assets/images/Deployments_%C2%B7_spacelift-io_marcinw-end-to-end%20%282%29.png)

If the [Applying](../../concepts/run/tracked.md#applying) phase succeeds (fingers crossed!), the deployment is marked as _Active_:

![](/assets/images/Deployments_%C2%B7_spacelift-io_marcinw-end-to-end.png)
...
![](/assets/images/spacelift-io_infra__Infrastructure_definitions_for_Spacelift.png)

That's what it looks like for our test repo, with just a singe stack pointing at it:

![](/assets/images/Deployments_%C2%B7_spacelift-io_marcinw-end-to-end%20%284%29.png)
...
![](/assets/images/Pull_Requests_%C2%B7_Spacelift_development.png)
