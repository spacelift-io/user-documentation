...
1. On the _Integrations_ screen, click **View** on the _GitLab_ card, then **Set up GitLab**.
...
1. On the _Integrations > GitLab_ page, click the **three dots** next to the integration name.
...
If you no longer need the integration, you can delete it by clicking the 3 dots next to the integration name on the _Integrations > GitLab_ page, and then clicking **Delete**. You need **admin** access to the integration Space to be able to delete it.
