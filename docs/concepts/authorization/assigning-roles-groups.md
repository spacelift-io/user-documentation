...
IdP groups can receive roles through one method:

- **Direct Group Assignment**: Assign roles to the entire group, which automatically applies to all members of that group.
