...
![](../../assets/screenshots/Contexts_·_marcinwyszynski.png)
...
![](<../../assets/screenshots/Contexts_·_marcinwyszynski (1).png>)

This takes you to a simple form where the only inputs are name and description:

![](../../assets/screenshots/New_context_·_marcinwyszynski.png)
...
![](../../assets/screenshots/Managed_context_·_marcinwyszynski.png)
...
![](../../assets/screenshots/Editing_Managed_context_·_marcinwyszynski.png)
...
![](<../../assets/screenshots/Edit_stack_·_Managed_stack (1).png>)
...
![](<../../assets/screenshots/Edit_stack_·_End-to-end_testing (1).png>)
...
![](<../../assets/screenshots/Edit_stack_·_End-to-end_testing (2).png>)
...
![](../../assets/screenshots/Production_Kubernetes_cluster_Ireland_·_marcinwyszynski.png)
