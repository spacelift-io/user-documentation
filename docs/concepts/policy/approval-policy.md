...
!!! info
    Note that this is just an example meant for informational purposes (json doesn't support comments by design).  You can get a sample using the [policy workbench](../policy.md#policy-workbench).
