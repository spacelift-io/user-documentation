...
assigning [RBAC roles](../authorization/README.md) programmatically. Unlike all other policy types, login policies are
...
Spacelift - the other being [User Management](../user-management/) for GUI-based permission management.
